...
HttpClient.prototype.request = function(rurl, data, callback, exheaders, exoptions, security) {
  var self = this;
  var options = self.buildRequest(rurl, data, exheaders, exoptions);
  var headers = options.headers;

     if (security._type === 'ntlm') {
        delete headers.Connection;

        httpntlm[options.method.toLowerCase()]({
            url: rurl,
            username: security._username,
            password: security._password,
            headers: headers,
            body: data
